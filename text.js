...
function getElementInfo() {
    const elementInput = document.getElementById('elementInput').value.trim().toLowerCase();
    const elementInfoDiv = document.getElementById('elementInfo');
    const element = periodicTable.find(elem => elem.name.toLowerCase() === elementInput);
    ...
    if (element) {
        ...
        elementInfoDiv.innerHTML = 'Element not found.';
    }
}
